...
const SubmitForm = ({ footer }: { footer: any }) => {
  return (
    <div
      id='#support'
    ...
    >
      <div className='flex flex-col gap-4'>
        <Text type='font-16-400'>{footer?.description}</Text>
        <div className='flex items-center gap-4'>
          <div className='hover:opacity-80 cursor-pointer'>
            <IconFacebook onClick={() => window.open(footer?.url_facebook)} />
          </div>
          <div className='hover:opacity-80 cursor-pointer'>
            <IconYoutube onClick={() => window.open(footer?.url_youtube)} />
          </div>
          <div className='hover:opacity-80 cursor-pointer'>
            <IconTiktok onClick={() => window.open(footer?.url_tiktok)} />
          </div>
        </div>
      </div>
      <div className='flex flex-col gap-4'>
...
const IconFacebook = ({ onClick }: { onClick: VoidFunction }) => {
  return (
    <svg
      onClick={onClick}
...
const IconYoutube = ({ onClick }: { onClick: VoidFunction }) => {
  return (
    <svg
      onClick={onClick}
      xmlns='http://www.w3.org/2000/svg'
...
const IconTiktok = ({ onClick }: { onClick: VoidFunction }) => {
  return (
    <svg
      onClick={onClick}
      xmlns='http://www.w3.org/2000/svg'
